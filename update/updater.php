...
<script type="text/javascript"> 
	...
	function downloadBranch()
	{
		...
		var urlForSend = urlForSendMain;
		document.getElementById('innerDisplayUpdate').innerHTML = settingsForBranchStuff['versionList'][versionToUpdateTo]['releaseNotes'];
		var data = {action: 'downloadFile', file: settingsForBranchStuff['versionList'][versionToUpdateTo]['branchName'],downloadFrom: 'Monitor/archive/', downloadTo: '../../update/downloads/updateFiles/updateFiles.zip'};
		$.ajax({
			url: urlForSend,
			dataType: 'json',
			data: data,
	...
	{
		document.getElementById('innerSettingsText').innerHTML = "<p>An error occured while trying to update Monitor. </p>";
	}
